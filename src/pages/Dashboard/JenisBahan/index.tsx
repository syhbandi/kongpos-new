...
import { GetJenisBahansType } from "../../../constants/Types/jenisBahanTypes";
import { useRecoilValue } from "recoil";
import { companyIdState, userState } from "../../../atom/User";
import { getJenisBahans } from "../../../api/jenisBahan";
import Table from "../../../components/Table";
import jenisBahanColumns from "../../../constants/ColumnsHelper/jenisBahan";
...
const index = () => {
  ...
  const [params, setParams] = useState<GetJenisBahansType>({
    company_id,
    length: 10,
    limit: 0,
    order_col: "",
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["jenisBahan", params],
    queryFn: () => getJenisBahans(params, access_token),
  });
  return (
    <>
      <h1 className="text-2xl font-poppins font-semibold mb-5">Jenis Bahan</h1>
