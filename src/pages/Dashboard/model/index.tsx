...
import { GetModelsType } from "../../../constants/Types/modelTypes";
import { useRecoilValue } from "recoil";
import { companyIdState, userState } from "../../../atom/User";
import { getModels } from "../../../api/model";
import Table from "../../../components/Table";
import modelColumns from "../../../constants/ColumnsHelper/model";
...
const index = () => {
  ...
  const [params, setParams] = useState<GetModelsType>({
    company_id,
    length: 10,
    limit: 0,
    order_col: "",
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: () => getModels(params, access_token),
  });
  return (
    <>
      <h1 className="text-2xl font-poppins font-semibold mb-5">Model</h1>
