...
import { GetKategorisType } from "../../../constants/Types/kategoriTypes";
import { useRecoilValue } from "recoil";
import { companyIdState, userState } from "../../../atom/User";
import { getKategoris } from "../../../api/kategori";
import Table from "../../../components/Table";
import kategoriColumns from "../../../constants/ColumnsHelper/kategori";
...
const index = () => {
  ...
  const [params, setParams] = useState<GetKategorisType>({
    company_id,
    length: 10,
    limit: 0,
    order_col: "",
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["kategori", params],
    queryFn: () => getKategoris(params, access_token),
  });
  return (
    <>
      <h1 className="text-2xl font-poppins font-semibold mb-5">Kategori</h1>
