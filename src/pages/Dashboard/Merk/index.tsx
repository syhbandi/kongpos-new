...
import { GetMerksType } from "../../../constants/Types/merkTypes";
...
const index = () => {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ["merk", params],
    queryFn: () => getMerks(params, access_token),
  });
  return (
    <>
      <h1 className="text-2xl font-poppins font-semibold mb-5">Merk</h1>
