...
const Detail = ({ awal, akhir, jenis }: Props) => {
  ...
  const queries = useQueries({
    queries: [
      {
        queryKey: ["orderPembelian", params],
        queryFn: () => getOrderPembelian(params, access_token),
      },
      {
        queryKey: ["orderPembelian", { ...params, count_stats: 1 }],
        queryFn: () =>
          getOrderPembelian({ ...params, count_stats: 1 }, access_token),
      },
    ],
  });
